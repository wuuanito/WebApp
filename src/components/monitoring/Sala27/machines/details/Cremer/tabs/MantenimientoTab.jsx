...
const MantenimientoTab = ({ cremerData }) => {
  return (
          ...
          <CardContent className="p-6">
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-base font-medium text-gray-900">{cremerData.proximoMantenimiento}</p>
              </div>
              <div>
          ...
          <CardContent className="p-6">
            <div className="space-y-4">
              <div>
                ...
                <p className="text-base font-medium text-gray-900">{cremerData.ultimoMantenimiento}</p>
              </div>
              <div>
