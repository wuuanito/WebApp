...
const EnvasadoraPolvo = () => {
  ...
  const { data, connectionStatus } = useWebSocket('ws://192.168.20.71:8765');
  ...
  return (
    <Card className="hover:shadow-lg transition-shadow duration-200 h-full flex flex-col">
      <CardHeader className="pb-2 px-3 sm:px-6 pt-3 sm:pt-6">
        <CardTitle className="text-base sm:text-lg font-semibold">EnvasadoraPolvo</CardTitle>
...
export default EnvasadoraPolvo;