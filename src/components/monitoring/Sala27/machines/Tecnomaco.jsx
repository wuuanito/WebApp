...
const Tecnomaco = () => {
  ...
  const { data, connectionStatus } = useWebSocket('ws://192.168.20.223:8765');
    ...
    const fetchOrdenes = async () => {
      try {
        ...
        const [responseLimpieza, responseFabricacion] = await Promise.all([
          fetch('http://192.168.11.7:3005/api/ordenes-limpieza'),
          fetch('http://192.168.11.7:3005/api/ordenes-fabricacion')
        ]);
