...
const VialesPitillo = ({ onOpenModal }) => {
  ...
  const { data, connectionStatus } = useWebSocket('ws://192.168.20.33:8765');
  ...
  return (
    <Card 
      className="hover:shadow-lg transition-shadow duration-200 h-full flex flex-col cursor-pointer hover:bg-gray-50" 
      onClick={handleCardClick}
    >
      <CardHeader className="pb-2 px-3 sm:px-6 pt-3 sm:pt-6">
        <CardTitle className="text-base sm:text-lg font-semibold">Viales Pitillo</CardTitle>
